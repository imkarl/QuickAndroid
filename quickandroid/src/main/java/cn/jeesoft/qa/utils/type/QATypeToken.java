...
public class QATypeToken<T> {
     ...
     */
    @Deprecated
    public boolean isAssignableFrom(QATypeToken<?> token) {
    ...
    public final boolean equals(Object o) {
        return o instanceof QATypeToken<?>
                && $Type$Types.equals(type, ((QATypeToken<?>) o).type);
    }
     ...
     */
    public static QATypeToken<?> get(Type type) {
        return new QATypeToken<Object>(type);
    }

    /**
     * Gets type literal for the given {@code Class} instance.
     */
    public static <T> QATypeToken<T> get(Class<T> type) {
        return new QATypeToken<T>(type);
    }
}
